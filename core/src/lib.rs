 ...
 * | `date`                      | `chrono::NaiveDate`<br>`elephantry::Date`          | date       |
 ...
 * | `timestamp`                 | `chrono::NaiveDateTime`<br>`elephantry::Timestamp` | date       |
 * | `timestamptz`               | `chrono::DateTime`<br>`elephantry::Timestamp`      | date       |
