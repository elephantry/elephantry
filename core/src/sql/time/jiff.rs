...
type TimeTz = (jiff::civil::Time, jiff::tz::TimeZone);
...
impl crate::ToSql for TimeTz {
     ...
     */
    fn to_text(&self) -> crate::Result<Option<String>> {
        let (offset, _, _) = self.1.to_offset(jiff::Timestamp::UNIX_EPOCH);
        format!("{}{offset}", self.0).to_text()
    }
    ...
    fn to_binary(&self) -> crate::Result<Option<Vec<u8>>> {
        ...
        crate::to_sql::write_i32(&mut buf, -offset.seconds())?;
...
impl crate::FromSql for TimeTz {
    ...
    fn from_binary(ty: &crate::pq::Type, raw: Option<&[u8]>) -> crate::Result<Self> {
        ...
        Ok((
            ...
            jiff::tz::Offset::from_seconds(-zone)
...
mod test {
    ...
    crate::sql_test!(
        ...
        [
            (
                "'00:00:00+0000'",
                (jiff::civil::Time::midnight(), jiff::tz::TimeZone::UTC)
            ),
            (
                "'01:02:03+0200'",
                (
                    jiff::civil::time(1, 2, 3, 0),
                    jiff::tz::offset(2).to_time_zone()
                )
            ),
        ]
    );
